...
x = [1e-3, 1e-4, 1000, 20, 0.02, 1, 0.4, 0.08,  1e-3, 1e-3, 0.001, 0.0001];
t = logspace(-3,4,100);
clear global
% -------------------
global hDp hDp_der
...
for i=1:length(tD)
     ...
     for j=1:N
        ...
        % W = sqrt(30*z*omga1/remda1);
        % fs1 = omga1+remda1*(W*coth(W)-1)/(10*z);   % Eq5.37,不稳定窜流
        fs2 = M12*temp;
        y = PWD_inf(z,fs1,fs2,M12,LfD,rmD,nf,xwD);
        pf = y(nf+1);
        % ------------
...
% ===================================================================
function pf = PWD_inf(z,fs1,fs2,M12,LfD,rmD,nf,xwD)
